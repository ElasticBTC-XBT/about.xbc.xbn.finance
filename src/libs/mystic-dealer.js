...
export const getSaleRule = async (web3Client) => {
    ...
    const saleRate = await dealerContract.methods.getAmountsOut(1,['0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c','0x0321394309CaD7E0E424650844c3AB3b659315d3']).call();
